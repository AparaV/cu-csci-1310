...
f7 = 0
f8 = 0
#generates a file path to data directory and .wav files in that directory
...
#create a sound object from a wav file, individual samples that make up the wav file
aa = pygame.mixer.Sound(a)
buf = pygame.sndarray.array(aa)
for item in buf:
	print item
...
'''
The pygame sound mixer documentation is here:
http://www.pygame.org/docs/ref/mixer.html#pygame.mixer.init
Can you control the volume of the sound?
'''
